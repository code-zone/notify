...
<html>
<head>
<title>{{config('app.name')}} Hotel and Restaurant Website  | Home :: {{config('app.name')}}</title>
...
<div class="top-navg ">
    ...
    <div class="menu menu-li">
      <ul class=" head-icons wow bounceInRight menu-list" data-wow-delay="0.3s">
          <li class="menu-item menu-item-current"><a href="{{ route('login') }}" class="menu-link"> Login </a></li>
      </ul>
    </div>
                ...
                <div class="col-md-4 furniture-grid no-marg wow bounceInRight" data-wow-delay="0.3s">
                    <div class="furni-small-grid">
                       ...
                       <div class="furnitu-right">
                          <h5><a href="single.html">These cases are perfectly</a></h5>
